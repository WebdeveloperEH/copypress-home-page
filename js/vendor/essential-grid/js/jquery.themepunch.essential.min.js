...
!(function (jQuery, undefined) {
      ...
      is_mobile() &&
        jQuery(document).on("click touchstart", function (e) {
          ...
          0 == a.length &&
            ...
            t.container.find(".esg-dropdown-wrapper").stop().hide());
        }),
  ...
  function waitMediaListeners(e) {
    var t = e.find("iframe").first(),
      ...
      o =
        t.length > 0 && t.attr("src").toLowerCase().indexOf("youtube") > 0
          ? "y"
          : t.length > 0 && t.attr("src").toLowerCase().indexOf("vimeo") > 0
          ? "v"
          : t.length > 0 && t.attr("src").toLowerCase().indexOf("wistia") > 0
          ? "w"
          : t.length > 0 &&
            t.attr("src").toLowerCase().indexOf("soundcloud") > 0
          ? "s"
    ...
    var n = setInterval(function () {
      (go ||
        ...
        r.attr("src") != undefined &&
          (r.attr("src").toLowerCase().indexOf("youtube") > 0 && playYT(r, o),
          r.attr("src").toLowerCase().indexOf("vimeo") > 0 && playVimeo(r, o),
          r.attr("src").toLowerCase().indexOf("wistia") > 0 && playWs(r, o),
          r.attr("src").toLowerCase().indexOf("soundcloud") > 0 &&
            playSC(r, o)));
    }, 100);
  }
